...
;
const metadata = {
    title: 'Nuva - Your AI-Powered Medication & Health Companion',
    description: 'Never miss a medication again. Nuva helps you manage medications, scan prescriptions using AI, and get personalized health guidance.',
    generator: 'v0.app',
    icons: {
        icon: [
            {
